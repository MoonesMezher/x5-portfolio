...
const DashboardSection = () => {
  ...
  const messages = [
    { id: '1', name: 'Alice', email: 'alice@example.com', body: 'Hello, Alice!' },
    { id: '2', name: 'Bob', email: 'bob@example.com', body: 'Hi, Bob!' },
    { id: '3', name: 'Charlie', email: 'charlie@example.com', body: 'Hey, Charlie!' },
    { id: '4', name: 'David', email: 'david@example.com', body: 'Greetings, David!' },
    { id: '5', name: 'Eve', email: 'eve@example.com', body: 'Salutations, Eve!' },
    { id: '6', name: 'Frank', email: 'frank@example.com', body: 'Greetings, Frank!' },
    { id: '7', name: 'Grace', email: 'grace@example.com', body: 'Hello, Grace!' },
    { id: '8', name: 'Heidi', email: 'heidi@example.com', body: 'Hi, Heidi!' },
    { id: '9', name: 'Ivan', email: 'ivan@example.com', body: 'Hey, Ivan!' },
    { id: '10', name: 'Steve', email: 'steve@example.com', body: 'Greetings, Steve!' }
  ];
  ...
  return (
    <section className="page dashboard-section">
        <h1>{section}</h1>
        <p>Count of {section} is {data.length} </p>
